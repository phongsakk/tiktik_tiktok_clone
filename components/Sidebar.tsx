...
const Sidebar = () => {
  ...
  return (
    <div className='w-[80px] xl:w-auto'>
      <div
      ...
      {(showSidebar || width > 1280) && (
        <div className='absolute xl:relative xl:w-400 w-20 flex flex-col justify-start mb-10 border-r-2 border-gray-100 xl:border-0 p-3'>
